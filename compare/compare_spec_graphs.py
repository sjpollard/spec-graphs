...
def compare_lbm_t_gnu_speedup(tx2_mpi_times, tx2_omp_times, g2_mpi_times, g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_speedup.T[0], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_speedup.T[0], c="green", linestyle="solid", marker="x", label="G2 OMP 8x8")
    plt.plot([1,2,4,8], g2_mpi_speedup.T[0], c="green", linestyle="dashed", marker=".", label="G2 MPI") 
    plt.plot([1,2,4,8], g3_omp_speedup.T[0], c="blue", linestyle="solid", marker="x", label="G3 OMP 16x4")
    plt.plot([1,2,4,8], g3_mpi_speedup.T[0], c="blue", linestyle="dashed", marker=".", label="G3 MPI") 
...
def compare_lbm_t_gnu_time(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_times.T[0], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_times.T[0], c="green", linestyle="solid", marker="x", label="G2 OMP 8x8")
    plt.plot([1,2,4,8], g2_mpi_times.T[0], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_times.T[0], c="blue", linestyle="solid", marker="x", label="G3 OMP 16x4")
    plt.plot([1,2,4,8], g3_mpi_times.T[0], c="blue", linestyle="dashed", marker=".", label="G3 MPI") 
...
def compare_soma_t_gnu_speedup(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_speedup.T[1], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_speedup.T[1], c="green", linestyle="solid", marker="x", label="G2 OMP 2x32")
    plt.plot([1,2,4,8], g2_mpi_speedup.T[1], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_speedup.T[1], c="blue", linestyle="solid", marker="x", label="G3 OMP 4x16")
    plt.plot([1,2,4,8], g3_mpi_speedup.T[1], c="blue", linestyle="dashed", marker=".", label="G3 MPI") 
    plt.legend(loc="upper left")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
...
def compare_soma_t_gnu_time(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_times.T[1], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_times.T[1], c="green", linestyle="solid", marker="x", label="G2 OMP 2x32")
    plt.plot([1,2,4,8], g2_mpi_times.T[1], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_times.T[1], c="blue", linestyle="solid", marker="x", label="G3 OMP 4x16")
    plt.plot([1,2,4,8], g3_mpi_times.T[1], c="blue", linestyle="dashed", marker=".", label="G3 MPI") 
    plt.legend(loc="upper right")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Time(s)")
...
def compare_tealeaf_t_gnu_speedup(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_speedup.T[2], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_speedup.T[2], c="green", linestyle="solid", marker="x", label="G2 OMP 8x8")
    plt.plot([1,2,4,8], g2_mpi_speedup.T[2], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_speedup.T[2], c="blue", linestyle="solid", marker="x", label="G3 OMP 1x64")
    plt.plot([1,2,4,8], g3_mpi_speedup.T[2], c="blue", linestyle="dashed", marker=".", label="G3 MPI") 
    plt.legend(loc="upper left")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
...
def compare_tealeaf_t_gnu_time(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_times.T[2], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_times.T[2], c="green", linestyle="solid", marker="x", label="G2 OMP 8x8")
    plt.plot([1,2,4,8], g2_mpi_times.T[2], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_times.T[2], c="blue", linestyle="solid", marker="x", label="G3 OMP 1x64")
    plt.plot([1,2,4,8], g3_mpi_times.T[2], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper right")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Time(s)")
...
def compare_clvleaf_t_gnu_speedup(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_speedup.T[3], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_speedup.T[3], c="green", linestyle="solid", marker="x", label="G2 OMP 4x16")
    plt.plot([1,2,4,8], g2_mpi_speedup.T[3], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_speedup.T[3], c="blue", linestyle="solid", marker="x", label="G3 OMP 32x2")
    plt.plot([1,2,4,8], g3_mpi_speedup.T[3], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper left")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
...
def compare_clvleaf_t_gnu_time(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_times.T[3], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_times.T[3], c="green", linestyle="solid", marker="x", label="G2 OMP 4x16")
    plt.plot([1,2,4,8], g2_mpi_times.T[3], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_times.T[3], c="blue", linestyle="solid", marker="x", label="G3 OMP 32x2")
    plt.plot([1,2,4,8], g3_mpi_times.T[3], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper right")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Time(s)")
...
def compare_miniswp_t_gnu_speedup(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_speedup.T[4], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_speedup.T[4], c="green", linestyle="solid", marker="x", label="G2 OMP 4x16")
    plt.plot([1,2,4,8], g2_mpi_speedup.T[4], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_speedup.T[4], c="blue", linestyle="solid", marker="x", label="G3 OMP 4x16")
    plt.plot([1,2,4,8], g3_mpi_speedup.T[4], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper left")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
...
def compare_miniswp_t_gnu_time(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_times.T[4], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_times.T[4], c="green", linestyle="solid", marker="x", label="G2 OMP 4x16")
    plt.plot([1,2,4,8], g2_mpi_times.T[4], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_times.T[4], c="blue", linestyle="solid", marker="x", label="G3 OMP 4x16")
    plt.plot([1,2,4,8], g3_mpi_times.T[4], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper right")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Time(s)")
...
def compare_pot3d_t_gnu_speedup(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_speedup.T[5], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_speedup.T[5], c="green", linestyle="solid", marker="x", label="G2 OMP 2x32")
    plt.plot([1,2,4,8], g2_mpi_speedup.T[5], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_speedup.T[5], c="blue", linestyle="solid", marker="x", label="G3 OMP 8x8")
    plt.plot([1,2,4,8], g3_mpi_speedup.T[5], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper left")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
...
def compare_pot3d_t_gnu_time(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_times.T[5], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_times.T[5], c="green", linestyle="solid", marker="x", label="G2 OMP 2x32")
    plt.plot([1,2,4,8], g2_mpi_times.T[5], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_times.T[5], c="blue", linestyle="solid", marker="x", label="G3 OMP 8x8")
    plt.plot([1,2,4,8], g3_mpi_times.T[5], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper right")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Time(s)")
...
def compare_sph_exa_t_gnu_speedup(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_speedup.T[6], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_speedup.T[6], c="green", linestyle="solid", marker="x", label="G2 OMP 2x32")
    plt.plot([1,2,4,8], g2_mpi_speedup.T[6], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_speedup.T[6], c="blue", linestyle="solid", marker="x", label="G3 OMP 2x32")
    plt.plot([1,2,4,8], g3_mpi_speedup.T[6], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper left")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
...
def compare_sph_exa_t_gnu_time(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_times.T[6], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_times.T[6], c="green", linestyle="solid", marker="x", label="G2 OMP 2x32")
    plt.plot([1,2,4,8], g2_mpi_times.T[6], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_times.T[6], c="blue", linestyle="solid", marker="x", label="G3 OMP 2x32")
    plt.plot([1,2,4,8], g3_mpi_times.T[6], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper right")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Time(s)")
...
def compare_hpgmgfv_t_gnu_speedup(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_speedup.T[7], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_speedup.T[7], c="green", linestyle="solid", marker="x", label="G2 OMP 16x4")
    plt.plot([1,2,4,8], g2_mpi_speedup.T[7], c="green", linestyle="dashed", marker=".", label="G2 MPI") 
    plt.plot([1,2,4,8], g3_omp_speedup.T[7], c="blue", linestyle="solid", marker="x", label="G3 OMP 32x2")
    plt.plot([1,2,4,8], g3_mpi_speedup.T[7], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper left")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
...
def compare_hpgmgfv_t_gnu_time(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_times.T[7], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_times.T[7], c="green", linestyle="solid", marker="x", label="G2 OMP 16x4")
    plt.plot([1,2,4,8], g2_mpi_times.T[7], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_times.T[7], c="blue", linestyle="solid", marker="x", label="G3 OMP 32x2")
    plt.plot([1,2,4,8], g3_mpi_times.T[7], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper right")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Time(s)")
...
def compare_weather_t_gnu_speedup(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_speedup.T[8], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_speedup.T[8], c="green", linestyle="solid", marker="x", label="G2 OMP 8x8")
    plt.plot([1,2,4,8], g2_mpi_speedup.T[8], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_speedup.T[8], c="blue", linestyle="solid", marker="x", label="G3 OMP 16x4")
    plt.plot([1,2,4,8], g3_mpi_speedup.T[8], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper left")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
...
def compare_weather_t_gnu_time(tx2_mpi_times, tx2_omp_times, g2_mpi_times,g2_omp_times, g3_mpi_times, g3_omp_times):
    ...
    plt.plot([1,2,4,8], tx2_mpi_times.T[8], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_omp_times.T[8], c="green", linestyle="solid", marker="x", label="G2 OMP 8x8")
    plt.plot([1,2,4,8], g2_mpi_times.T[8], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_omp_times.T[8], c="blue", linestyle="solid", marker="x", label="G3 OMP 16x4")
    plt.plot([1,2,4,8], g3_mpi_times.T[8], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper right")
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Time(s)")
...
def compare_tiny_gnu_total_time(tx2_times, g2_times, g3_times):
    ...
    plt.plot([1,2,4,8], tx2_times[6], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    ...
    plt.plot([1,2,4,8], g3_times[1], c="blue", linestyle="solid", marker="x", label="G3 OMP 2x32")
...
def compare_tiny_gnu_spec_score(tx2_scores, g2_scores, g3_scores):
    ...
    plt.plot([1,2,4,8], tx2_scores[6], c="red", linestyle="dashed", marker=".", label="TX2 MPI")
    plt.plot([1,2,4,8], g2_scores[3], c="green", linestyle="solid", marker="x", label="G2 OMP 8x8")
    plt.plot([1,2,4,8], g2_scores[6], c="green", linestyle="dashed", marker=".", label="G2 MPI")
    plt.plot([1,2,4,8], g3_scores[1], c="blue", linestyle="solid", marker="x", label="G3 OMP 2x32")
    plt.plot([1,2,4,8], g3_scores[6], c="blue", linestyle="dashed", marker=".", label="G3 MPI")
    plt.legend(loc="upper left")
    plt.xlabel("Number of nodes (64 cores/node)")
...
def main():
    ...
    g3_tiny_gnu_spec_scores = np.array([[3.51,6.24,11.1,18.8],
                                        [3.59,6.64,11.9,20.4],
                                        [3.67,6.84,12.2,19.8],
                                        [3.66,6.81,11.8,18.9],
                                        [3.62,6.63,11.8,8.94],
    ...
    compare_lbm_t_gnu_speedup(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_16ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_8ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_16ppn_times)
    compare_lbm_t_gnu_time(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_16ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_8ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_16ppn_times)
    compare_soma_t_gnu_speedup(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_2ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_2ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_4ppn_times)
    compare_soma_t_gnu_time(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_2ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_2ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_4ppn_times)
    compare_tealeaf_t_gnu_speedup(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_8ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_1ppn_times)
    compare_tealeaf_t_gnu_time(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_8ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_1ppn_times)
    compare_clvleaf_t_gnu_speedup(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_4ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_32ppn_times)
    compare_clvleaf_t_gnu_time(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_4ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_32ppn_times)
    compare_miniswp_t_gnu_speedup(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_2ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_4ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_4ppn_times)
    compare_miniswp_t_gnu_time(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_2ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_4ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_4ppn_times)
    compare_pot3d_t_gnu_speedup(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_2ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_2ppn_times)
    compare_pot3d_t_gnu_time(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_2ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_2ppn_times)
    compare_sph_exa_t_gnu_speedup(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_2ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_2ppn_times)
    compare_sph_exa_t_gnu_time(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_2ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_2ppn_times)
    compare_hpgmgfv_t_gnu_speedup(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_16ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_32ppn_times)
    compare_hpgmgfv_t_gnu_time(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_32ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_16ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_32ppn_times)
    compare_weather_t_gnu_speedup(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_8ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_8ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_16ppn_times)
    compare_weather_t_gnu_time(tx2_tiny_gnu_mpi_times, tx2_tiny_gnu_omp_8ppn_times, g2_tiny_gnu_mpi_times, g2_tiny_gnu_omp_8ppn_times, g3_tiny_gnu_mpi_times, g3_tiny_gnu_omp_16ppn_times)
