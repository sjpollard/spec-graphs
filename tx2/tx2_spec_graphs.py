...
def tx2_tiny_gnu_mpi_time(times):
    ...
    plt.savefig("tx2_tiny_gnu_mpi_time.pdf")
    plt.clf()

def tx2_tiny_gnu_mpi_speedup(times):
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
    plt.savefig("tx2_tiny_gnu_mpi_speedup.pdf")
    plt.clf()

def tx2_tiny_gnu_mpi_efficiency(times):
    speedup = times[0]/times
    ...
    plt.savefig("tx2_tiny_gnu_mpi_efficiency.pdf")
    plt.clf()
...
def tx2_tiny_gnu_omp_1ppn_time(times):
    times = np.log10(times)
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("$log_{10}$ Time(s)")
    plt.savefig("tx2_tiny_gnu_omp_1ppn_time.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_1ppn_speedup(times):
    speedup = times[0]/times
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
    plt.savefig("tx2_tiny_gnu_omp_1ppn_speedup.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_1ppn_efficiency(times):
    speedup = times[0]/times
    efficiency = speedup/np.array([[1],[2],[4],[8]]) * 100
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Parallel efficiency(%)")
    plt.savefig("tx2_tiny_gnu_omp_1ppn_efficiency.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_2ppn_time(times):
    times = np.log10(times)
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("$log_{10}$ Time(s)")
    plt.savefig("tx2_tiny_gnu_omp_2ppn_time.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_2ppn_speedup(times):
    speedup = times[0]/times
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
    plt.savefig("tx2_tiny_gnu_omp_2ppn_speedup.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_2ppn_efficiency(times):
    speedup = times[0]/times
    efficiency = speedup/np.array([[1],[2],[4],[8]]) * 100
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Parallel efficiency(%)")
    plt.savefig("tx2_tiny_gnu_omp_2ppn_efficiency.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_4ppn_time(times):
    times = np.log10(times)
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("$log_{10}$ Time(s)")
    plt.savefig("tx2_tiny_gnu_omp_4ppn_time.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_4ppn_speedup(times):
    speedup = times[0]/times
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
    plt.savefig("tx2_tiny_gnu_omp_4ppn_speedup.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_4ppn_efficiency(times):
    speedup = times[0]/times
    efficiency = speedup/np.array([[1],[2],[4],[8]]) * 100
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Parallel efficiency(%)")
    plt.savefig("tx2_tiny_gnu_omp_4ppn_efficiency.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_8ppn_time(times):
    times = np.log10(times)
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("$log_{10}$ Time(s)")
    plt.savefig("tx2_tiny_gnu_omp_8ppn_time.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_8ppn_speedup(times):
    speedup = times[0]/times
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
    plt.savefig("tx2_tiny_gnu_omp_8ppn_speedup.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_8ppn_efficiency(times):
    speedup = times[0]/times
    efficiency = speedup/np.array([[1],[2],[4],[8]]) * 100
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Parallel efficiency(%)")
    plt.savefig("tx2_tiny_gnu_omp_8ppn_efficiency.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_16ppn_time(times):
    times = np.log10(times)
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("$log_{10}$ Time(s)")
    plt.savefig("tx2_tiny_gnu_omp_16ppn_time.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_16ppn_speedup(times):
    speedup = times[0]/times
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
    plt.savefig("tx2_tiny_gnu_omp_16ppn_speedup.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_16ppn_efficiency(times):
    speedup = times[0]/times
    efficiency = speedup/np.array([[1],[2],[4],[8]]) * 100
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Parallel efficiency(%)")
    plt.savefig("tx2_tiny_gnu_omp_16ppn_efficiency.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_32ppn_time(times):
    times = np.log10(times)
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("$log_{10}$ Time(s)")
    plt.savefig("tx2_tiny_gnu_omp_32ppn_time.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_32ppn_speedup(times):
    speedup = times[0]/times
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Speedup")
    plt.savefig("tx2_tiny_gnu_omp_32ppn_speedup.pdf")
    plt.clf()

def tx2_tiny_gnu_omp_32ppn_efficiency(times):
    speedup = times[0]/times
    efficiency = speedup/np.array([[1],[2],[4],[8]]) * 100
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("Parallel efficiency(%)")
    plt.savefig("tx2_tiny_gnu_omp_32ppn_efficiency.pdf")
    plt.clf()

def tx2_tiny_gnu_total_time(times):
    times = np.log10(times)
    ...
    plt.xlabel("Number of nodes (64 cores/node)")
    plt.ylabel("$log_{10}$ Time(s)")
    plt.savefig("tx2_tiny_gnu_total_time.pdf")
    plt.clf()
...
def tx2_tiny_gnu_spec_score(scores):
    ...
    plt.savefig("tx2_tiny_gnu_spec_score.pdf")   
    plt.clf() 
...
def main():
    ...
    tx2_tiny_mpi_total_times = np.array([tx2_tiny_gnu_mpi_times.sum(axis=1),
    ...
    tx2_tiny_gnu_spec_scores = np.array([[1.27,2.43,4.39,7.50],
                                      ...
                                      [1.75,3.02,5.49,9.84],
                                      [1.61,3.03,5.54,9.71]])
    tx2_tiny_gnu_mpi_time(tx2_tiny_gnu_mpi_times)
    tx2_tiny_gnu_mpi_speedup(tx2_tiny_gnu_mpi_times)
    tx2_tiny_gnu_mpi_efficiency(tx2_tiny_gnu_mpi_times)
    ...
    tx2_tiny_gnu_omp_1ppn_time(tx2_tiny_gnu_omp_1ppn_times)
    tx2_tiny_gnu_omp_1ppn_speedup(tx2_tiny_gnu_omp_1ppn_times)
    tx2_tiny_gnu_omp_1ppn_efficiency(tx2_tiny_gnu_omp_1ppn_times)
    tx2_tiny_gnu_omp_2ppn_time(tx2_tiny_gnu_omp_2ppn_times)
    tx2_tiny_gnu_omp_2ppn_speedup(tx2_tiny_gnu_omp_2ppn_times)
    tx2_tiny_gnu_omp_2ppn_efficiency(tx2_tiny_gnu_omp_2ppn_times)
    tx2_tiny_gnu_omp_4ppn_time(tx2_tiny_gnu_omp_4ppn_times)
    tx2_tiny_gnu_omp_4ppn_speedup(tx2_tiny_gnu_omp_4ppn_times)
    tx2_tiny_gnu_omp_4ppn_efficiency(tx2_tiny_gnu_omp_4ppn_times)
    tx2_tiny_gnu_omp_8ppn_time(tx2_tiny_gnu_omp_8ppn_times)
    tx2_tiny_gnu_omp_8ppn_speedup(tx2_tiny_gnu_omp_8ppn_times)
    tx2_tiny_gnu_omp_8ppn_efficiency(tx2_tiny_gnu_omp_8ppn_times)
    tx2_tiny_gnu_omp_16ppn_time(tx2_tiny_gnu_omp_16ppn_times)
    tx2_tiny_gnu_omp_16ppn_speedup(tx2_tiny_gnu_omp_16ppn_times)
    tx2_tiny_gnu_omp_16ppn_efficiency(tx2_tiny_gnu_omp_16ppn_times)
    tx2_tiny_gnu_omp_32ppn_time(tx2_tiny_gnu_omp_32ppn_times)
    tx2_tiny_gnu_omp_32ppn_speedup(tx2_tiny_gnu_omp_32ppn_times)
    tx2_tiny_gnu_omp_32ppn_efficiency(tx2_tiny_gnu_omp_32ppn_times)
    tx2_tiny_gnu_total_time(tx2_tiny_gnu_total_times)
    tx2_tiny_mpi_total_time(tx2_tiny_mpi_total_times)
    tx2_tiny_gnu_spec_score(tx2_tiny_gnu_spec_scores)
